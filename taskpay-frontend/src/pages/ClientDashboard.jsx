...
import ApplicantsModal from '../components/ClientDashboard/ApplicantsModal.jsx';
...
function ClientDashboard() {
    ...
    }, [navigate, currentCompletedTasksPage, taskFilter]);
    ...
    const handleViewApplicantInfo = useCallback(async (applicantId) => {
        ...
        try {
            ...
            if (response.data.success) {
                setProfileDataForModal(response.data); 
            }
        } catch (error) {
